...
struct film {
  ...
  inline ostream& operator<<(ostream& os, const film& rhs) {
    os << "Film is " << rhs.title << " and is produced in " << rhs.year;
    return os;
  }
...
inline const char *determinePathToData(const char *userSelectedPath = NULL)
{
  ...
  //   return "/home/shixin/course/cs107/programming_assignment/6degree/assn-2-six-degrees-data/little-endian/";
  // if (strcasecmp(ostype, "solaris") == 0)
  //   return "/home/shixin/course/cs107/assignments/assn-2-six-degrees-data/big-endian/";
