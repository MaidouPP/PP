...
class imdb {
 ...
 public:
  ...
  void extractFilms(vector<film>& films, void* found, const string& player) const;
  ...
  void extractPlayers(vector<string>& players, void* found, const film& film) const;
 ...
 private:
  ...
  // int compareActor(const void* keyt, const void* candidate);
};
